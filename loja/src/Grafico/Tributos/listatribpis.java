...
import beans.TribpisBean;
import entidades.Tribpis;


public class listatribpis extends JDialog {
	public JTable table;
	public Long idT;
	public int id, linhaSel;
	TribpisBean l = new TribpisBean();
	Tribpis pis1 = new Tribpis();
	AcessoBean aces1 = new AcessoBean();
	private JPanel contentPane;
	DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
	public DefaultTableModel listatribpis = new DefaultTableModel() {
		@Override
	...
	public listatribpis(final Tribpis c) throws Exception {
		setModal(true);
		setResizable(false);
		...
		listatribpis.addColumn("id");
		listatribpis.addColumn("CODIGO");
		listatribpis.addColumn("TITULO");
	...
	public void carregartabela() throws Exception {
		...
		TribpisBean lista = new TribpisBean();
		List<Tribpis> list =  lista.lista();

		for (Tribpis tri : list) {
			listatribpis.addRow(new Object[] { tri.getIdtribpis(),
