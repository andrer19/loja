...
import beans.TribicmsBean;
import entidades.Tribicms;

public class listatribicms extends JDialog {
	public JTable table;
	public Long idT;
	public int id, linhaSel;
	TribicmsBean l = new TribicmsBean();
	Tribicms icms1 = new Tribicms();
	AcessoBean aces1 = new AcessoBean();
	private JPanel contentPane;
	DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
	public DefaultTableModel listatribicms = new DefaultTableModel() {
		@Override
	...
	public listatribicms(final Tribicms c) throws Exception {
		setModal(true);
		setResizable(false);
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setBounds(470, 250, 582, 285);
		...
		scrollPane_1.setViewportBorder(new LineBorder(new Color(0, 0, 0), 3,
				true));
		scrollPane_1.setBounds(0, 0, 578, 260);
		setBackground(getBackground());
		setForeground(Color.BLACK);

		contentPane.add(scrollPane_1);
		table = new JTable(listatribicms){
		...
		listatribicms.addColumn("id");
		listatribicms.addColumn("CODIGO");
		listatribicms.addColumn("TITULO");
	...
	public void carregartabela() throws Exception {
		...
		TribicmsBean lista = new TribicmsBean();
		List<Tribicms> list =  lista.lista();

		for (Tribicms tri : list) {
			listatribicms.addRow(new Object[] { tri.getIdtribicms(),
