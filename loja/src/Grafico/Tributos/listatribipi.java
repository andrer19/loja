...
import beans.TribipiBean;
import entidades.Tribipi;


public class listatribipi extends JDialog {
	public JTable table;
	public Long idT;
	public int id, linhaSel;
	TribipiBean l = new TribipiBean();
	Tribipi icms1 = new Tribipi();
	AcessoBean aces1 = new AcessoBean();
	private JPanel contentPane;
	DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
	public DefaultTableModel listatribipi = new DefaultTableModel() {
		@Override
	...
	public listatribipi(final Tribipi c) throws Exception {
		setModal(true);
		setResizable(false);
		...
		listatribipi.addColumn("id");
		listatribipi.addColumn("CODIGO");
		listatribipi.addColumn("TITULO");
	...
	public void carregartabela() throws Exception {
		...
		TribipiBean lista = new TribipiBean();
		List<Tribipi> list =  lista.lista();

		for (Tribipi tri : list) {
			listatribipi.addRow(new Object[] { tri.getIdtribipi(),
